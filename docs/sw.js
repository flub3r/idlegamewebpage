const CACHE='hashnova-rich-v5';const ASSETS=['./','./index.html','./styles.css','./game-data.js','./game-core.js','./motion-runtime.js','./game-ui.js','./runtime-fixes.js','./manifest.webmanifest','./sw.js'];
